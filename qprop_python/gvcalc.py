...
def GVCALC(CHORD,BETA,R,BLDS,RAD,VEL,OMG,VSO,CL0,DCLDA,CLMIN,CLMAX,MCRIT,
    GAM,GAM_VEL,GAM_OMG,GAM_CH,GAM_BE,VA, VA_VEL, VA_OMG, VA_CH, VA_BE, VT,
    VT_VEL, VT_OMG, VT_CH, VT_BE, CL, CL_VEL, CL_OMG, CL_CH, CL_BE, STALL, LCONV):
...
# C------ Newton update
    ...
    if(ABS(DPSI) < EPS):
        LCONV = True
        print 'GVCALC: Not converged.  Res a CL =', RES, A, CL
